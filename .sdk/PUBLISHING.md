...
|---|---|---|
| `ts/` | @voxgig-sdk/currency-exchange-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/currency-exchange-sdk \
      --repository voxgig-sdk/currency-exchange-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/currency-exchange-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/currency-exchange-sdk --id=<id>` removes one.
