...
// CurrencyExchange SDK cache feature
...
class CurrencyExchangeCacheFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _through(CurrencyExchangeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
