...
// CurrencyExchange SDK idempotency feature
...
class CurrencyExchangeIdempotencyFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _mutating(CurrencyExchangeContext $ctx): bool
    {
