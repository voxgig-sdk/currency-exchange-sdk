...
// CurrencyExchange SDK metrics feature
...
class CurrencyExchangeMetricsFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _record(CurrencyExchangeContext $ctx, bool $ok): void
    {
