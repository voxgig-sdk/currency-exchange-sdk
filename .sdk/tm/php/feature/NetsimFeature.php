...
// CurrencyExchange SDK netsim feature
...
class CurrencyExchangeNetsimFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _simulate(CurrencyExchangeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CurrencyExchangeContext $ctx, array $applied): void
    {
        $client = $this->client;
