...
// CurrencyExchange SDK proxy feature
...
class CurrencyExchangeProxyFeature extends CurrencyExchangeBaseFeature
{
    ...
    public function init(CurrencyExchangeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CurrencyExchangeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
