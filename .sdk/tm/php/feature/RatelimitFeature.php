...
// CurrencyExchange SDK ratelimit feature
...
class CurrencyExchangeRatelimitFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _acquire(CurrencyExchangeContext $ctx): void
    {
    ...
    private function _track(CurrencyExchangeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
