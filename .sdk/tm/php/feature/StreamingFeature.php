...
// CurrencyExchange SDK streaming feature
...
class CurrencyExchangeStreamingFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _iterate(CurrencyExchangeResult $result): \Generator
    {
    ...
    private function _streamable(CurrencyExchangeContext $ctx): bool
    {
