...
// CurrencyExchange SDK telemetry feature
...
class CurrencyExchangeTelemetryFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _close(CurrencyExchangeContext $ctx, bool $ok): void
    {
