...
// CurrencyExchange SDK utility: graphql
//
...
class CurrencyExchangeGraphql
{
    ...
    // equivalent.
    public static function body(CurrencyExchangeContext $ctx): mixed
    {
    ...
    public static function errors(CurrencyExchangeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
