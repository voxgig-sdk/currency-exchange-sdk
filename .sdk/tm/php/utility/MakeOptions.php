...
// CurrencyExchange SDK utility: make_options

class CurrencyExchangeMakeOptions
{
    ...
    public static function call(CurrencyExchangeContext $ctx): array
    {
        ...
        //
        // `CurrencyExchangeSchema::optspec()` is built from the model:
        ...
        $optspec = CurrencyExchangeSchema::optspec();
