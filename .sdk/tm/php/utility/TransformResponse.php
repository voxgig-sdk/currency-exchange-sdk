...
// CurrencyExchange SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CurrencyExchangeTransformResponse
{
    public static function call(CurrencyExchangeContext $ctx): mixed
    {
        ...
        $transform = CurrencyExchangeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
