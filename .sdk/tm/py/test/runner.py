...
class CurrencyExchangeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CurrencyExchangeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CurrencyExchangeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CurrencyExchangeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
