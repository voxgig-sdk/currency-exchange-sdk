...
Provides daily currency exchange rates and performs conversions between a wide range of global currencies and cryptos.

Learn more about Currency Exchange API at [hub.juheapi.com](https://hub.juheapi.com).
...
This SDK exposes the API as a small set of **semantic entities** — Convert and Rate — that you
...
| Python | `voxgig-sdk-currency-exchange-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/currency-exchange-sdk/tags) |
| PHP | `voxgig-sdk/currency-exchange-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/currency-exchange-sdk/tags) |
| Golang | `github.com/voxgig-sdk/currency-exchange-sdk/go` | `go get github.com/voxgig-sdk/currency-exchange-sdk/go@latest` |
| Ruby | `voxgig-sdk-currency-exchange-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/currency-exchange-sdk/tags) |
| Lua | `voxgig-sdk-currency-exchange-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/currency-exchange-sdk/tags) |
