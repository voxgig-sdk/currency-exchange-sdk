...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/currency-exchange` | `npm install @voxgig-sdk/currency-exchange` |
| Python | `voxgig-sdk-currency-exchange` | `pip install voxgig-sdk-currency-exchange` |
| PHP | `voxgig-sdk/currency-exchange` | `composer require voxgig-sdk/currency-exchange` |
| Golang | `github.com/voxgig-sdk/currency-exchange-sdk/go` | `go get github.com/voxgig-sdk/currency-exchange-sdk/go` |
| Ruby | `voxgig-sdk-currency-exchange` | `gem install voxgig-sdk-currency-exchange` |
| Lua | `voxgig-sdk-currency-exchange` | `luarocks install voxgig-sdk-currency-exchange` |
