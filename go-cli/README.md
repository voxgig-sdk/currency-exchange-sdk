...
AQL-driven CLI and REPL for the CurrencyExchange SDK. Positional arguments are
...
```sh
go build -o currency-exchange-cli ./...
```
...
./currency-exchange-cli list convert
./currency-exchange-cli load 1 convert
./currency-exchange-cli load '{id:1}' convert
