// Command CurrencyExchange-cli is a CLI + REPL for the CurrencyExchange SDK,
...
const prompt = "currency-exchange"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "convert rate"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      CURRENCY_EXCHANGE_APIKEY (api key), CURRENCY_EXCHANGE_BASE (base url override)")
