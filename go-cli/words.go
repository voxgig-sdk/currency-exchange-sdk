...
func registerSDKWords(r *eng.Registry, client *sdk.CurrencyExchangeSDK) {
...
func runOp(client *sdk.CurrencyExchangeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
