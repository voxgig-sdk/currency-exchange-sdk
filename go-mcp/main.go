// Command CurrencyExchange-mcp is an MCP server exposing the CurrencyExchange
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CurrencyExchange_list  — list records of an entity
//	CurrencyExchange_load  — load a single record of an entity
//
