...
func main() {
    ...
    convert, err := client.Convert(nil).Load(map[string]any{"from": "example_from", "key": "example_key", "to": "example_to"}, nil)
    if err != nil {
        panic(err)
    }
    fmt.Println(convert)
...
```go
convert, err := client.Convert(nil).Load(map[string]any{"from": "example", "key": "example", "to": "example"}, nil)
if err != nil {
    // handle err
    return
}
...
convert, err := client.Convert(nil).Load(
    map[string]any{"from": "example", "key": "example", "to": "example"}, nil,
)
if err != nil {
    panic(err)
}
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *CurrencyExchangeSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### CurrencyExchangeSDK methods
...
| `Convert` | `(data map[string]any) CurrencyExchangeEntity` | Create a Convert entity instance. |
| `Rate` | `(data map[string]any) CurrencyExchangeEntity` | Create a Rate entity instance. |

### Entity interface (CurrencyExchangeEntity)

All entities implement the `CurrencyExchangeEntity` interface.
...
```go
convert, err := client.Convert(nil).Load(map[string]any{"from": "from", "key": "key", "to": "to"}, nil)
if err != nil {
    panic(err)
}
...
```go
rate, err := client.Rate(nil).Load(map[string]any{"base": "base", "key": "key"}, nil)
if err != nil {
    panic(err)
}
...
```
github.com/voxgig-sdk/currency-exchange-sdk/go/
├── currency-exchange.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/currency-exchange-sdk/go`) re-exports everything needed
...
convert.Load(map[string]any{"from": "example", "key": "example", "to": "example"}, nil)
