...
type CurrencyExchangeSDK struct {
	Mode     string
...
func (sdk *CurrencyExchangeSDK) OptionsMap() map[string]any {
...
func (sdk *CurrencyExchangeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CurrencyExchangeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CurrencyExchangeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CurrencyExchangeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CurrencyExchangeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CurrencyExchangeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CurrencyExchangeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CurrencyExchangeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CurrencyExchangeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CurrencyExchangeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *CurrencyExchangeSDK {
	...
	sdk := NewCurrencyExchangeSDK(sdkopts)
	sdk.Mode = "test"
