...
// instead of `sdk.NewCurrencyExchangeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *CurrencyExchangeSDK  { return NewCurrencyExchangeSDK(nil) }
func Test() *CurrencyExchangeSDK { return TestSDK(nil, nil) }
