...
type RateEntity struct {
	name    string
	client  *core.CurrencyExchangeSDK
...
func NewRateEntity(client *core.CurrencyExchangeSDK, entopts map[string]any) *RateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RateEntity) GetName() string { return e.name }
...
func (e *RateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RateEntity) Deleted() bool {
	return e.deleted
}


func (e *RateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRateEntity(e.client, opts)
}

func (e *RateEntity) Data(args ...any) any {
...
func (e *RateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RateEntity) DataTyped(data ...Rate) Rate {
	if len(data) > 0 {
		return typedFrom[Rate](e.Data(asMap(data[0])))
	}
	return typedFrom[Rate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rate (all fields
// optional at the wire level).
func (e *RateEntity) MatchTyped(match ...Rate) Rate {
	if len(match) > 0 {
		return typedFrom[Rate](e.Match(asMap(match[0])))
	}
	return typedFrom[Rate](e.Match())
}
...
func (e *RateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RateLoadMatch and returns an Rate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RateEntity) LoadTyped(reqmatch RateLoadMatch, ctrl map[string]any) (Rate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Rate{}, err
	}
	return typedFrom[Rate](res), nil
}



func (e *RateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
