...
func TestConvertEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set CURRENCYEXCHANGE_TEST_CONVERT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func convertBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("CURRENCYEXCHANGE_TEST_CONVERT_ENTID")
