...
const testSeed = `map[string]any{"entity": map[string]any{"convert": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
