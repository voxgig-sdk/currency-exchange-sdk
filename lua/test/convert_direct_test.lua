...
describe("ConvertDirect", function()
  it("should direct-load-convert", function()
    local setup = convert_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-convert", setup.live and "live" or "unit")
