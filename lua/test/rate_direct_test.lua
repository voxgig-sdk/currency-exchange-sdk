...
describe("RateDirect", function()
  it("should direct-load-rate", function()
    local setup = rate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rate", setup.live and "live" or "unit")
...
function rate_direct_setup(mockres)
