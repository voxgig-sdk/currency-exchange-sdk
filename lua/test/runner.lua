...
function runner.env_override(m)
  local live = runner.getenv("CURRENCYEXCHANGE_TEST_LIVE")
  local override = runner.getenv("CURRENCYEXCHANGE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CURRENCYEXCHANGE_TEST_EXPLAIN")
