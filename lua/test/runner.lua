...
function runner.env_override(m)
  local live = runner.getenv("CURRENCY_EXCHANGE_TEST_LIVE")
  local override = runner.getenv("CURRENCY_EXCHANGE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CURRENCY_EXCHANGE_TEST_EXPLAIN")
