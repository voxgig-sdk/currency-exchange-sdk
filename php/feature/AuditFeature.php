...
// CurrencyExchange SDK audit feature
...
class CurrencyExchangeAuditFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _emit(CurrencyExchangeContext $ctx, string $outcome): void
    {
