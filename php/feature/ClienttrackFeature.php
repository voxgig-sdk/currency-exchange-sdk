...
// CurrencyExchange SDK clienttrack feature
...
class CurrencyExchangeClienttrackFeature extends CurrencyExchangeBaseFeature
{
    ...
    public function PostConstruct(CurrencyExchangeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CurrencyExchange-SDK';
