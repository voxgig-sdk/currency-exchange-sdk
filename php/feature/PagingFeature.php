...
// CurrencyExchange SDK paging feature
...
class CurrencyExchangePagingFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _is_list(CurrencyExchangeContext $ctx): bool
    {
