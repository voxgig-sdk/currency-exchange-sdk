...
// CurrencyExchange SDK rbac feature
...
class CurrencyExchangeRbacFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _required(CurrencyExchangeContext $ctx): ?string
    {
    ...
    private function _reject(CurrencyExchangeContext $ctx, string $required): void
    {
    ...
    private function _track(CurrencyExchangeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
