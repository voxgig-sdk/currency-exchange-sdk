...
// CurrencyExchange SDK timeout feature
...
class CurrencyExchangeTimeoutFeature extends CurrencyExchangeBaseFeature
{
    ...
    private function _with_timeout(CurrencyExchangeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CurrencyExchangeContext $_ctx, float $ms): void
    {
        $client = $this->client;
