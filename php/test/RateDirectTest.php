...
class RateDirectTest extends TestCase
{
    public function test_direct_load_rate(): void
    {
        $setup = rate_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-rate", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
