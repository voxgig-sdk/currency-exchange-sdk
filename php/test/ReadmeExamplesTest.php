...
// CurrencyExchange SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CurrencyExchangeSDK::test)
...
{
    private const SDK_CLASS = 'CurrencyExchangeSDK';
    ...
    private const SDK_BASE = 'currencyexchange_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../currencyexchange_sdk.php';
