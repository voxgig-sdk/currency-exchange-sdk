...
class CurrencyExchangeTestRunner
{
    ...
    {
        $live = self::getenv('CURRENCY_EXCHANGE_TEST_LIVE');
        $override = self::getenv('CURRENCY_EXCHANGE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CURRENCY_EXCHANGE_TEST_EXPLAIN');
...
class_alias('CurrencyExchangeTestRunner', 'Runner');
class_alias('CurrencyExchangeHelpers', 'Helpers');
