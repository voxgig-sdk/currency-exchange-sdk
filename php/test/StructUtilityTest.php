...
// CurrencyExchange SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CurrencyExchangeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CurrencyExchangeOmni::structfix($now, Struct::undef()))
                        !== json_encode(CurrencyExchangeOmni::structfix($val, Struct::undef()))) {
