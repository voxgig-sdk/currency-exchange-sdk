...
class CurrencyExchangeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CurrencyExchangeSDK/1.0)';
    ...
    public static function call(CurrencyExchangeContext $ctx, string $fullurl, array $fetchdef): array
    {
