# CurrencyExchange Python SDK



The Python SDK for the CurrencyExchange API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/currency-exchange-sdk/releases)) or
...
```python
client = CurrencyExchangeSDK.test(testopts, sdkopts)
```
...
```
py/
├── currencyexchange_sdk.py         -- Main SDK module
...
The main module (`currencyexchange_sdk`) exports the SDK class.
