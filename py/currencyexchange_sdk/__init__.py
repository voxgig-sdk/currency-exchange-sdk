...
from currencyexchange_sdk.utility import register

# Load features
from currencyexchange_sdk.feature.base_feature import CurrencyExchangeBaseFeature
from currencyexchange_sdk.features import _has_feature, _make_feature
...
class CurrencyExchangeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CurrencyExchangeUtility()
        self._utility = utility

        from currencyexchange_sdk.config import shared_config
    ...
    def get_utility(self):
        return CurrencyExchangeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CurrencyExchangeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Convert(self, data=None) -> "ConvertEntity":
        ...
        from currencyexchange_sdk.entity.convert_entity import ConvertEntity
        return ConvertEntity(self, data)


    def Rate(self, data=None) -> "RateEntity":
        """Entity factory: client.Rate().list() / client.Rate().load({"id": ...})."""
        from currencyexchange_sdk.entity.rate_entity import RateEntity
