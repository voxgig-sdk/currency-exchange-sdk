...
from currencyexchange_sdk.core.control import CurrencyExchangeControl
...
from currencyexchange_sdk.core.helpers import get_ctx_prop, to_map
...
class CurrencyExchangeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CurrencyExchangeControl()
        ...
        if isinstance(sp, CurrencyExchangeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CurrencyExchangeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CurrencyExchangeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CurrencyExchangeError(code, msg, self)
