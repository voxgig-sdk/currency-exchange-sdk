...
from currencyexchange_sdk.core.spec import CurrencyExchangeSpec
from currencyexchange_sdk.core.result import CurrencyExchangeResult
from currencyexchange_sdk.core.response import CurrencyExchangeResponse
from currencyexchange_sdk.core.operation import CurrencyExchangeOperation
from currencyexchange_sdk.core.error import CurrencyExchangeError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CurrencyExchangeError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = CurrencyExchangeResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = CurrencyExchangeSDK.test(None, None)
        ...
        class TestInitFeature(CurrencyExchangeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CurrencyExchangeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = CurrencyExchangeSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = CurrencyExchangeSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CurrencyExchangeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CurrencyExchangeSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = CurrencyExchangeOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CurrencyExchangeSDK.test(None, setup_opts)
