# CurrencyExchange SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CurrencyExchangeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CurrencyExchangeSDK(...) and CurrencyExchangeSDK.test(...) become
#      CurrencyExchangeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "currencyexchange_sdk"
_SDK_CLASS = "CurrencyExchangeSDK"
