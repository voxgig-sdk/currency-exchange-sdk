...
The Ruby SDK for the CurrencyExchange API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `CurrencyExchangeError` (a `StandardError` subclass), so wrap
