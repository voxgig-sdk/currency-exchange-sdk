...
#      offline in seeded test mode (CurrencyExchangeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CurrencyExchange_sdk.rb")
  SDK_CLASS = "CurrencyExchangeSDK"
