...
(0, node_test_1.describe)('ConvertDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CurrencyExchangeSDK({
    ...
    (0, node_test_1.test)('direct-load-convert', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-convert', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CURRENCY_EXCHANGE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CurrencyExchangeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.CURRENCY_EXCHANGE_APIKEY,
        }));
        let idmap = env['CURRENCY_EXCHANGE_TEST_CONVERT_ENTID'];
    ...
    const client = new __1.CurrencyExchangeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ConvertDirect.test.js.map